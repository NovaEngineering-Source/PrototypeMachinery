 ...
 * ## Related Classes / 相关类
 * 
 * - [github.kasuminova.prototypemachinery.api.recipe.requirement.component.system.RecipeRequirementSystem] - Returns ProcessResult
...
public sealed class ProcessResult {
    ...
    /**
     * Operation blocked/paused.
     * 
     * 操作被阻塞/暂停。
     * 
     * Indicates that the process cannot proceed currently but should not be aborted.
     * (e.g., waiting for input, output full)
     * 
     * 表示进程当前无法继续，但不应中止。
     * （例如：等待输入、输出已满）
     */
