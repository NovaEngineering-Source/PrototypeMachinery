...
public class FluidHatchFluidHandler(
    ...
    override fun fill(resource: FluidStack?, doFill: Boolean): Int {
        ...
        val inserted = blockEntity.storage.insertFluid(resource, !doFill)
    ...
    override fun drain(resource: FluidStack?, doDrain: Boolean): FluidStack? {
        ...
        return blockEntity.storage.extractFluidResult(resource, resource.amount, !doDrain)
    }
    ...
    override fun drain(maxDrain: Int, doDrain: Boolean): FluidStack? {
        ...
        return blockEntity.storage.drain(maxDrain, !doDrain)
    }
