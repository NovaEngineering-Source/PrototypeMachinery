...
internal object GeckoAnimationDriver {
    ...
    private class Runtime(
        ...
        fun applyToModel(geoModel: GeoModel, resourceManager: IResourceManager, seekTimeTicks: Double) {
        ...
        private inner class RuntimeModel : IAnimatableModel<Runtime> {
            ...
            private val animationProcessor: AnimationProcessor<Runtime> = AnimationProcessor(this)

            @Volatile
            var animationFile: AnimationFile? = null
