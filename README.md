...
- 客户端渲染性能与调优（HUD / RenderTuning / VBO 缓存 / Chunk 缓存）：[`docs/RenderingPerformance.md`](./docs/RenderingPerformance.md)
- 结构渲染数据同步（StructureRenderDataComponent：FULL/INCREMENTAL）：[`docs/StructureRenderDataSync.md`](./docs/StructureRenderDataSync.md)
- Modern Backend（Cleanroom / Java 21+ / Vector API）：[`docs/ModernBackend.md`](./docs/ModernBackend.md)
